...
export function buildEnvVars(env: MoltbotEnv): Record<string, string> {
  ...
  if (env.DASHSCOPE_API_KEY) envVars.DASHSCOPE_API_KEY = env.DASHSCOPE_API_KEY;
  if (env.DASHSCOPE_MODEL) envVars.DASHSCOPE_MODEL = env.DASHSCOPE_MODEL;
  ...
  if (env.FEISHU_VERIFICATION_TOKEN) envVars.FEISHU_VERIFICATION_TOKEN = env.FEISHU_VERIFICATION_TOKEN;
  if (env.FEISHU_ENCRYPT_KEY) envVars.FEISHU_ENCRYPT_KEY = env.FEISHU_ENCRYPT_KEY;
